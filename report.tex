...
\normalsize{IN THE SUCCESSFULLY COMPLETION OF THE REQUIREMENTS}\\
...
Deepika Jaiswal (Asst. Professor), it is approved for the successful completion of the 
...
\includegraphics[scale=0.95]{firstPage-1.png}
