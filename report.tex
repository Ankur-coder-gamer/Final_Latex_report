...
\includepdf[pages=-]{LitSurvey.pdf}
...
\begin{itemize}
    \item User Registration: Firstly, user need to register in the system.
...
\normalsize
\begin{itemize}
    \item  Machine Learning Based Music Recommendation System Using Facial 
Expressions
\end{itemize}
