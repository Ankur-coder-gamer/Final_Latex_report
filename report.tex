...
\begin{longtable}{|c|p{4cm}|p{4cm}|}
  \hline
  \textbf{Test Case ID} & \textbf{Test Cases} & \textbf{Actual Result} \\
  \hline
  \endhead
...
\vspace{1.5cm}
\normalsize
\subsubsection{ Testing with NUnit in Unity:}
...
\textbf{Edit mode tests:}
\begin{center}
\includegraphics[scale=0.2]{ image18.png}
\includegraphics[scale=0.2]{ image19.png}
\end{center}
\clearpage
\textbf{Play mode tests:}
\begin{center}
\includegraphics[scale=0.2]{ image17.png}
\includegraphics[scale=0.2]{ image16.png}
\end{center}
