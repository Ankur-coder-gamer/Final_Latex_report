...
\includepdf[pages={1-} ,offset=0cm 0cm]{Testing.pdf}
...
{Unity Multiplayer Game development with Photon PUN2 [2020],}
...
{Research on the 3D Game Scene Optimization of Mobile Phone Based on the Unity 3D Engine | IEEE Conference Publication,}

\item \href
    {https://ieeexplore.ieee.org/document/8052656}
    {Developing a game application to encourage face-to-face local gaming experience | IEEE Conference Publication | IEEE Xplore,}

\item \href
{https://ieeexplore.ieee.org/document/8052656}
{Developing MOBA games using the Unity game engine | IEEE Conference Publication | IEEE Xplore,}

\item \href
{https://ieeexplore.ieee.org/document/8968786}
{SOUL: Simulation of Objects in Unity for Learning | IEEE Conference Publication,}

\item \href
{https://ieeexplore.ieee.org/document/9427480}
{Computing Games: Bridging the Gap Between Search and Entertainment | IEEE Journals \& Magazine,}

\item \href
{https://ieeexplore.ieee.org/document/9403941}
{Game or Watch: The Effect of Interactivity on Arousal and Engagement in Video Game Media | IEEE Journals \& Magazine | IEEE Xplore,}
